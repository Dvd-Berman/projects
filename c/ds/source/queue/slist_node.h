...
void FreeAll(slist_node_t *head);
 ...
 * Algorithmic efficiency: O(1).											*/
slist_node_t *InsertAfter(slist_node_t *current_node, slist_node_t *new_node);
 ...
 * CAUTION! Neither node can be NULL!									*
 * Algorithmic efficiency: O(1).											*/
slist_node_t *Insert(slist_node_t *current_node, slist_node_t *new_node);
 ...
 * Algorithmic efficiency: O(1). 											*/
slist_node_t *Remove(slist_node_t *node);
 ...
 * Algorithmic efficiency: O(1). 											*/
slist_node_t *RemoveAfter(slist_node_t *node);
 ...
 * Algorithmic efficiency: O(n).											*/
size_t CountNodes(const slist_node_t *head);
 ...
 * Algorithmic efficiency: O(n).											*/
slist_node_t *FindNode(const slist_node_t *head, 
 ...
 * Algorithmic efficiency: O(n).											*/
slist_node_t *OpenLoop(slist_node_t *head);
 ...
 * Algorithmic efficiency: O(n).											*/
slist_node_t *FindIntersections(const slist_node_t *first, 
